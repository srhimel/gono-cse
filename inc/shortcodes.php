...
function attendance_shortcode($atts){
    ...
    while($q->have_posts()) : $q->the_post();
        ...
        $student_text = __( 'শিক্ষার্থী', 'srh-education-theme' );
        $teacher_text = __( 'শিক্ষক', 'srh-education-theme' );
        $employee_text = __( 'কর্মচারী', 'srh-education-theme' );
        $total_student_text = __( 'মোট শিক্ষার্থীর সংখ‍্যা', 'srh-education-theme' );
        $present_student_text = __( 'উপস্থিত শিক্ষার্থীর সংখ‍্যা', 'srh-education-theme' );
        $absent_student_text = __( 'অনুপস্থিত শিক্ষার্থীর সংখ‍্যা', 'srh-education-theme' );
        $total_teacher_text = __( 'মোট শিক্ষকের সংখ‍্যা', 'srh-education-theme' );
        $present_teacher_text = __( 'উপস্থিত শিক্ষকের সংখ‍্যা', 'srh-education-theme' );
        $absent_teacher_text = __( 'ছুটিতে থাকা শিক্ষকের সংখ‍্যা', 'srh-education-theme' );
        $total_employee_text = __( 'মোট কর্মচারীর সংখ‍্যা', 'srh-education-theme' );
        $present_employee_text = __( 'উপস্থিত কর্মচারীর সংখ‍্যা', 'srh-education-theme' );
        $absent_employee_text = __( 'ছুটিতে থাকা কর্মচারীর সংখ‍্যা', 'srh-education-theme' );
...
function calendar_shortcode($atts){
    ...
    $month_1 = __( 'জানুয়ারী', 'srh-education-theme' );
    $month_2 = __( 'ফেব্রুয়ারী', 'srh-education-theme' );
    $month_3 = __( 'মার্চ', 'srh-education-theme' );
    $month_4 = __( 'এপ্রিল', 'srh-education-theme' );
    $month_5 = __( 'মে', 'srh-education-theme' );
    $month_6 = __( 'জুন', 'srh-education-theme' );
    $month_7 = __( 'জুলাই', 'srh-education-theme' );
    $month_8 = __( 'আগস্ট', 'srh-education-theme' );
    $month_9 = __( 'সেপ্টেম্বর', 'srh-education-theme' );
    $month_10 = __( 'অক্টোবর', 'srh-education-theme' );
    $month_11 = __( 'নভেম্বর', 'srh-education-theme' );
    $month_12 = __( 'ডিসেম্বর', 'srh-education-theme' );
    $day_short_1 = __( 'রবি', 'srh-education-theme' );
    $day_short_2 = __( 'সোম', 'srh-education-theme' );
    $day_short_3 = __( 'মঙ্গল', 'srh-education-theme' );
    $day_short_4 = __( 'বুধ', 'srh-education-theme' );
    $day_short_5 = __( 'বৃহস্পতি', 'srh-education-theme' );
    $day_short_6 = __( 'শুক্র', 'srh-education-theme' );
    $day_short_7 = __( 'শনি', 'srh-education-theme' );
    $day_full_1 = __( 'রবিবার', 'srh-education-theme' );
    $day_full_2 = __( 'সোমবার', 'srh-education-theme' );
    $day_full_3 = __( 'মঙ্গলবার', 'srh-education-theme' );
    $day_full_4 = __( 'বুধবার', 'srh-education-theme' );
    $day_full_5 = __( 'বৃহস্পতিবার', 'srh-education-theme' );
    $day_full_6 = __( 'শুক্রবার', 'srh-education-theme' );
    $day_full_7 = __( 'শনিবার', 'srh-education-theme' );
    $legend_1_text = __( 'খবর', 'srh-education-theme' );
    $legend_2_text = __( 'নোটিশ', 'srh-education-theme' );
    $legend_3_text = __( 'রুটিন', 'srh-education-theme' );
    $legend_4_text = __( 'রেজাল্ট', 'srh-education-theme' );
    $legend_5_text = __( 'হাজিরা', 'srh-education-theme' );
    ...
    while($q->have_posts()) : $q->the_post();
        ...
        if(get_post_type() == 'attendance') {
            $event_title = __( 'হাজিরার তথ‍্য', 'srh-education-theme' );
        } else {
...
function all_event_modal_shortcode($atts){
    ...
    $publish_date_text = __( 'প্রকাশের তারিখ', 'srh-education-theme' );    
    $attendance_text = __( 'হাজিরার তথ‍্য', 'srh-education-theme' );    
    $attendance_date_text = __( 'হাজিরার তারিখ', 'srh-education-theme' );    
...
function results_shortcode($atts){
    ...
    $title_text = __( 'শিরোনাম', 'srh-education-theme' );
    $publish_date_text = __( 'প্রকাশের তারিখ', 'srh-education-theme' );
    $dl_text = __( 'ডাউনলোড', 'srh-education-theme' );
    $name_text = __( 'নাম', 'srh-education-theme' );
    $division_text = __( 'শাখা', 'srh-education-theme' );
    $roll_text = __( 'রোল', 'srh-education-theme' );
    $detail_text = __( 'বিস্তারিত দেখুন', 'srh-education-theme' );
...
function routines_shortcode($atts){
    ...
    $name_text = __( 'নাম', 'srh-education-theme' );
    $date_text = __( 'প্রকাশের তারিখ', 'srh-education-theme' );
    $dl_text = __( 'ডাউনলোড', 'srh-education-theme' );
...
function prostudents_shortcode($atts){
    ...
    $nextpage_text = __( 'পরের পাতা', 'srh-education-theme' );
    $prevpage_text = __( 'আগের পাতা', 'srh-education-theme' );
    $loading_text = __( 'লোড হচ্ছে ...', 'srh-education-theme' );
...
function vacencies_shortcode($atts){
    ...
    $nextpage_text = __( 'পরের পাতা', 'srh-education-theme' );
    $name_text = __( 'শুন‍্যপদের নাম', 'srh-education-theme' );
    $subj_text = __( 'শুন‍্যপদের বিষয়', 'srh-education-theme' );
    $start_text = __( 'পদ সৃষ্টির তারিখ', 'srh-education-theme' );
    $loading_text = __( 'লোড হচ্ছে ...', 'srh-education-theme' );
...
function employee_shortcode($atts){
    ...
    $nextpage_text = __( 'পরের পাতা', 'srh-education-theme' );
    $name_text = __( 'কর্মচারীর নাম', 'srh-education-theme' );
    $desi_text = __( 'পদবী', 'srh-education-theme' );
    $start_text = __( 'যোগদানের তারিখ', 'srh-education-theme' );
    $loading_text = __( 'লোড হচ্ছে ...', 'srh-education-theme' );
...
function teachers_shortcode($atts){
    ...
    $nextpage_text = __( 'পরের পাতা', 'srh-education-theme' );
    $photo_text = __( 'ছবি', 'srh-education-theme' );
    $name_text = __( 'শিক্ষকের নাম', 'srh-education-theme' );
    $desi_text = __( 'পদবী', 'srh-education-theme' );
    $start_text = __( 'যোগদানের তারিখ', 'srh-education-theme' );
    $mobile_text = __( 'Mobile Number', 'srh-education-theme' );
    $edu_text = __( 'Educational Status', 'srh-education-theme' );
    $loading_text = __( 'লোড হচ্ছে ...', 'srh-education-theme' );
    ...
    <div class="sikkhok">
        <a href="<?php echo get_the_permalink()?>">
            ...
            <div class="img-thumbnail">
                <div class="biothumb">
                    <?php echo get_the_post_thumbnail($idd, 'small') ?>
                    <div class="overlay">
                        <h4 class="">
...
function committee_shortcode($atts){
    ...
    $nextpage_text = __( 'পরের পাতা', 'srh-education-theme' );
    $photo_text = __( 'ছবি', 'srh-education-theme' );
    $name_text = __( 'সদস‍্যের নাম', 'srh-education-theme' );
    $desi_text = __( 'পদবী', 'srh-education-theme' );
    $start_text = __( 'শুরুর তারিখ', 'srh-education-theme' );
    $end_text = __( 'মেয়াদউত্তীর্ণের তারিখ', 'srh-education-theme' );
...
function photogallery_shortcode($atts){
    ...
    $date_text = __( 'তারিখে যুক্ত করা হয়েছে।', 'srh-education-theme' );
